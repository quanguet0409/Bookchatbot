...
class GUI:
    ...
    def setup_window(self):
        self.root.title("📚 BookStore AI Chatbot - Hệ thống tư vấn sách thông minh")
    ...
    def create_header(self):
        ...
        subtitle_label = tk.Label(left_frame,
                                 text="🤖 Trợ lý thông minh cho việc tìm kiếm và mua sách",
        ...
        catalog_btn = tk.Button(right_frame,
                               text="📖 Danh mục sách",
        ...
        catalog_btn.pack(anchor='e', pady=2)
